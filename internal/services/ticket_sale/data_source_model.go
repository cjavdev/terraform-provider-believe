...
type TicketSaleDataSourceModel struct {
	...
	FindOneBy      *TicketSaleFindOneByDataSourceModel `tfsdk:"find_one_by"`
}

func (m *TicketSaleDataSourceModel) toListParams(_ context.Context) (params believe.TicketSaleListParams, diags diag.Diagnostics) {
	...
	if !m.FindOneBy.PurchaseMethod.IsNull() {
		params.PurchaseMethod = believe.PurchaseMethod(m.FindOneBy.PurchaseMethod.ValueString())
	}

	return
}

type TicketSaleFindOneByDataSourceModel struct {
