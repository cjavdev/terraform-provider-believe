...
func TestClientTicketSaleDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*client_ticket_sale.ClientTicketSaleDataSourceModel)(nil)
	schema := client_ticket_sale.DataSourceSchema(context.TODO())
